...
def get_all_order_items(
    ...
    return templates.TemplateResponse(
        "orders.html",
        {"request": request, "order_items": order_items, "current_user": current_user},
    )


@pages_router.get("/orders/{order_id}/{item_id}")
def order_detail_page(request: Request, current_user: User = Depends(get_current_user)):
    return templates.TemplateResponse(
        "orderdetails.html", {"request": request, "current_user": current_user}
    )

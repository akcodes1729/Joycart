...
from app.db.models import Checkout, CheckoutItem,Cart, CartItem, Product, Checkout, CheckoutItem,Address,Payment,Order,OrderItems
import uuid,os,razorpay
    ...
    try:
        ...
        for item in cart_items:
            ...
            if product.seller_id == current_user.seller_id:
                raise HTTPException(
                    400,
                    "You cannot checkout your own product"
                )

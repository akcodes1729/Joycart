...
from app.admin.services.admin_service import (
    get_users,
    block_users,
    unblock_users,
    make_admin,
...
def admin_dashboard(request: Request, current_admin=Depends(get_current_admin)):
    return templates.TemplateResponse(
        "admin.html", {"request": request, "current_user": current_admin}
    )

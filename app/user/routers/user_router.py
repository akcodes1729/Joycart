...
from app.user.services.user_services import (
    create_user,
    authenticate_user,
    home,
    profile,
...
def add_address_endpoint(
    ...
    return RedirectResponse(redirect_to or "/profile?section=address", status_code=303)
...
def add_address(
    ...
    return templates.TemplateResponse(
        ...
        {"request": request, "checkout_id": checkout_id, "current_user": current_user},
    )
...
def delete_address_endpoint(
    ...
    return RedirectResponse("/profile?section=address", status_code=303)

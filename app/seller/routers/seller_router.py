...
from app.seller.services.seller_service import (
    register_seller,
    create_product,
    edit_product,
    delete_product,
...
def seller_dashboard(
    ...
    return templates.TemplateResponse(
        ...
        {"request": request, "store_name": seller.store_name.upper()},
    )
...
def seller_register_page(
    ...
    return templates.TemplateResponse(
        "seller_register.html", {"request": request, "current_user": current_user}
    )
...
def seller_product_add(request: Request, seller: Seller = Depends(get_current_seller)):
    return templates.TemplateResponse("seller_product_add.html", {"request": request})
...
def edit_product_page(
    ...
    return templates.TemplateResponse(
        "seller_product_edit.html", {"request": request, "product": product}
    )
...
def seller_products(
    ...
    return templates.TemplateResponse(
        "seller_products.html", {"request": request, "products": products}
    )
...
def get_seller_order(
    ...
    return templates.TemplateResponse(
        "seller_orders.html", {"request": request, "grouped_orders": grouped_orders}
    )

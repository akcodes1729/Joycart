...
from app.cart.services.cart_service import (
    add_to_carts,
    get_carts,
    update_quantity,
    delete_quantity,
...
def viewcart(request: Request, current_user: User = Depends(get_current_user)):
    return templates.TemplateResponse(
        "viewcart.html", {"request": request, "current_user": current_user}
    )
